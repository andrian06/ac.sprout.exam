...
export class EmployeeCreate extends Component {
    ...
    handleSubmit(e) {
        e.preventDefault();
        const { fullName, birthdate, tin } = this.state;

        if (!fullName || !birthdate || !tin) {
            alert('All fields are required.');
            return;
        }

        if (fullName.length > 100 || tin.length > 100) {
            alert('Full Name and TIN must be 100 characters or less.');
            return;
        }
                ...
                <form>
                    <div className='form-row'>
                        ...
                        <div className='form-group col-md-6'>
                            ...
                            <input type='date' className='form-control' id='inputBirthdate4' onChange={this.handleChange.bind(this)} name="birthdate" value={this.state.sbirthdate} placeholder='Birthdate' />
                        </div>
                    </div>
                    <div className="form-row">
                        <div className='form-group col-md-6'>
